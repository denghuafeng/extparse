...
namespace com.amonsoft.extparse
{
    public partial class FM_ExtParse : Form
    {
        ...
        {
            Process.Start("http://amonsoft.cn/soft/soft0001.aspx?sid=13010000");
        }
        ...
        {
            Process.Start("http://amonsoft.cn/idea/idea0001.aspx?sid=13010000");
        }
        ...
        private void ReadExtsData()
        {
            ...
            xml.Load(String.Format("http://amonsoft.cn/exts/exts0001.ashx?type=list&exts={0}", TF_ExtsName.Text.ToUpper()));
        ...
        private void ReadExtsInfo(XmlNode node)
        {
            ...
            PB_CorpIcon.ImageLocation = temp != null ? "http://amonsoft.cn" + temp.InnerText : null;
            ...
            PB_SoftIcon.ImageLocation = temp != null ? "http://amonsoft.cn" + temp.InnerText : null;
            ...
            PB_FileIcon.ImageLocation = temp != null ? "http://amonsoft.cn" + temp.InnerText : null;
            ...
            PB_IdioIcon.ImageLocation = temp != null ? "http://amonsoft.cn" + temp.InnerText : null;
            ...
            for (int i = 0; i < list.Count; i += 1)
            {
                ...
                if (temp != null)
                {
                    Stream stream = WebRequest.Create("http://amonsoft.cn" + temp.Attributes["icon"].Value + "&d=0010").GetResponse().GetResponseStream();
